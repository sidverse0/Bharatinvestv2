...
export default function DepositPage() {
  ...
  const stopTimer = useCallback((timerToStop: 'transaction' | 'approval' | 'both') => {
  ...
  }, [stopTimer, reloadUser, toast, router]);
        ...
        return (
          <div>
            ...
            <div className="flex flex-col items-center gap-4 mt-8">
                <Image src="https://files.catbox.moe/rhep39.jpg" data-ai-hint="qr code" alt="QR Code" width={250} height={250} className="rounded-lg border-2 border-primary shadow-[0_0_20px_hsl(var(--primary))]" />
