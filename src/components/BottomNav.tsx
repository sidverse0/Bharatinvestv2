...
import { Home, Landmark, History, User, Rocket } from 'lucide-react';
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/home', icon: Home, label: 'Home' },
  { href: '/my-investments', icon: Rocket, label: 'Invests' },
      ...
      <div className="container mx-auto h-full max-w-2xl">
        <div className="flex h-full items-center justify-around">
          {navItems.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href} className="flex flex-col items-center justify-center text-muted-foreground hover:text-primary transition-colors w-16 text-center">
